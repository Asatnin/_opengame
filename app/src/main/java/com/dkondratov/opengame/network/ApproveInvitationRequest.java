 ...
 */
public class ApproveInvitationRequest extends Request<JSONObject> {
    ...
    public ApproveInvitationRequest(Response.Listener listener, Response.ErrorListener errorListener, String invitationID, Context mContext) {
        super(Method.POST, String.format(Constants.ACCEPT_INVITATION, ApplicationUserData.loadUserId(mContext)), errorListener);
