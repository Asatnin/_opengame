 ...
 */
public class FieldsRequest extends Request<List<Field>> {

    private Response.Listener listener;
    private Gson gson;

    public FieldsRequest(Response.Listener listener, Response.ErrorListener errorListener, String sportId) {
        super(Method.GET, String.format(FIELDS_BY_ID, sportId), errorListener);
