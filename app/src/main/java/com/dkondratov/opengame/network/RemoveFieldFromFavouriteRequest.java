 ...
 */
public class RemoveFieldFromFavouriteRequest extends Request<String> {
    ...
    public RemoveFieldFromFavouriteRequest(Response.Listener listener, Response.ErrorListener errorListener, Context mContext, String fieldID) {
        super(Method.POST, String.format(Constants.REMOVE_FAVORITE), errorListener);
